...
class OLAPlugDLLHelper:
    ...
    def DmaGetProcAddress(cls, instance, deviceId, pid, moduleName, functionName):
        return cls._dll.DmaGetProcAddress(instance, deviceId, pid, moduleName.encode("utf-8"), functionName.encode("utf-8"))
    ...
    _dll.FindMultiColor.argtypes = [c_int64, c_int, c_int, c_int, c_int, c_char_p, c_char_p, c_double, c_int, POINTER(c_int), POINTER(c_int)]
    ...
    def FindMultiColor(cls, instance, x1, y1, x2, y2, colorJson, pointJson, sim, _dir, x = None, y = None):
        x = c_int(0)
        y = c_int(0)
        result = cls._dll.FindMultiColor(instance, x1, y1, x2, y2, colorJson.encode("utf-8"), pointJson.encode("utf-8"), sim, _dir, byref(x), byref(y))
        return result, x.value, y.value
    ...
    def FindMultiColorList(cls, instance, x1, y1, x2, y2, colorJson, pointJson, sim):
        return cls._dll.FindMultiColorList(instance, x1, y1, x2, y2, colorJson.encode("utf-8"), pointJson.encode("utf-8"), sim)

    _dll.FindMultiColorFromPtr.argtypes = [c_int64, c_int64, c_char_p, c_char_p, c_double, c_int, POINTER(c_int), POINTER(c_int)]
    ...
    def FindMultiColorFromPtr(cls, instance, ptr, colorJson, pointJson, sim, _dir, x = None, y = None):
        x = c_int(0)
        y = c_int(0)
        result = cls._dll.FindMultiColorFromPtr(instance, ptr, colorJson.encode("utf-8"), pointJson.encode("utf-8"), sim, _dir, byref(x), byref(y))
        return result, x.value, y.value
    ...
    def FindMultiColorListFromPtr(cls, instance, ptr, colorJson, pointJson, sim):
        return cls._dll.FindMultiColorListFromPtr(instance, ptr, colorJson.encode("utf-8"), pointJson.encode("utf-8"), sim)
    ...
    def FindImageFromPath(cls, instance, source, templ, deltaColor, matchVal, _dir):
        return cls._dll.FindImageFromPath(instance, source.encode("utf-8"), templ.encode("utf-8"), deltaColor.encode("utf-8"), matchVal, _dir)
    ...
    def FindImageFromPathAll(cls, instance, source, templ, deltaColor, matchVal):
        return cls._dll.FindImageFromPathAll(instance, source.encode("utf-8"), templ.encode("utf-8"), deltaColor.encode("utf-8"), matchVal)
    ...
    def FindWindowsFromPath(cls, instance, x1, y1, x2, y2, templ, deltaColor, matchVal, _dir):
        return cls._dll.FindWindowsFromPath(instance, x1, y1, x2, y2, templ.encode("utf-8"), deltaColor.encode("utf-8"), matchVal, _dir)
    ...
    def FindWindowsFromPathAll(cls, instance, x1, y1, x2, y2, templ, deltaColor, matchVal):
        return cls._dll.FindWindowsFromPathAll(instance, x1, y1, x2, y2, templ.encode("utf-8"), deltaColor.encode("utf-8"), matchVal)
