...
class OLAPlugServer:
    def __init__(self):
        ...
        self.UserCode = "7aad070e99c644e6a821c4a863668227"
        self.SoftCode = "3cad6186b3634affb9977bc5f48946bc"
        self.FeatureList = ""
        # 设置默认编码为UTF-8
    ...
    def GetStringFromPtr(self, ptr: int, lpString: str, size: int) -> int:
        r"""从指定内存地址读取字符串，参考windows函数 GetWindowText实现。.
    ...
    def SetConfig(self, configStr: str | dict) -> int:
        """修改用户自定义设置。.
    ...
    def PathPlanning(
        self, image: int, startX: int, startY: int, endX: int, endY: int, potentialRadius: float, searchRadius: float
    ) -> list[dict]:
        """寻路算法.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.PathPlanning(
                self.OLAObject, image, startX, startY, endX, endY, potentialRadius, searchRadius
            )
        )
        if result == "":
            return []
    ...
    def CreateGraphFromCoordinates(
        self, _json: str, connectAll: bool, maxDistance: float, useEuclideanDistance: bool
    ) -> int:
        """通过坐标创建图.
        ...
        """
        return OLAPlugDLLHelper.CreateGraphFromCoordinates(
            self.OLAObject, _json, connectAll, maxDistance, useEuclideanDistance
        )

    def AddCoordinateNode(
        self,
        graphPtr: int,
        name: str,
        x: float,
        ...
        """
        return OLAPlugDLLHelper.AddCoordinateNode(
            self.OLAObject, graphPtr, name, x, y, connectToExisting, maxDistance, useEuclideanDistance
        )
    ...
    def Disassemble(self, asmCode: str, baseAddr: int, arch: int, mode: int, showType: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.Disassemble(self.OLAObject, asmCode, baseAddr, arch, mode, showType)
        )
    ...
    def DmaAddDevice(self, vmId: int) -> int:
        ...
        Returns:
            成功返回设备ID(>=0), 失败返回-1
        """
        return OLAPlugDLLHelper.DmaAddDevice(self.OLAObject, vmId)
    ...
    def DmaAddDeviceEx(self, connectionString: str) -> int:
        ...
        Returns:
            成功返回设备ID(>=0), 失败返回-1
        """
        return OLAPlugDLLHelper.DmaAddDeviceEx(self.OLAObject, connectionString)
    ...
    def DmaRemoveDevice(self, deviceId: int) -> int:
        ...
        Returns:
            1 成功, 0 失败
        """
        return OLAPlugDLLHelper.DmaRemoveDevice(self.OLAObject, deviceId)
    ...
    def DmaGetPidFromName(self, deviceId: int, processName: str) -> int:
        ...
        Returns:
            成功返回PID, 失败返回0
        """
        return OLAPlugDLLHelper.DmaGetPidFromName(self.OLAObject, deviceId, processName)
    ...
    def DmaGetPidList(self, deviceId: int) -> str:
        ...
        Returns:
            返回PID列表字符串,格式: "pid1|pid2|pid3...",失败返回空字符串

        Notes:
            1. 返回的字符串指针需调用FreeStringPtr释放内存
        """
        return self.PtrToStringUTF8(OLAPlugDLLHelper.DmaGetPidList(self.OLAObject, deviceId))
    ...
    def DmaGetProcessInfo(self, deviceId: int, pid: int) -> str:
        ...
        Returns:
            返回进程信息字符串,格式: "进程名,镜像基址,镜像大小",失败返回空字符串

        Notes:
            1. 返回的字符串指针需调用FreeStringPtr释放内存
        """
        return self.PtrToStringUTF8(OLAPlugDLLHelper.DmaGetProcessInfo(self.OLAObject, deviceId, pid))
    ...
    def DmaGetModuleBase(self, deviceId: int, pid: int, moduleName: str) -> int:
        ...
        Returns:
            成功返回模块基址, 失败返回0
        """
        return OLAPlugDLLHelper.DmaGetModuleBase(self.OLAObject, deviceId, pid, moduleName)
    ...
    def DmaGetModuleSize(self, deviceId: int, pid: int, moduleName: str) -> int:
        ...
        Returns:
            成功返回模块大小, 失败返回0
        """
        return OLAPlugDLLHelper.DmaGetModuleSize(self.OLAObject, deviceId, pid, moduleName)
    ...
    def DmaGetProcAddress(self, deviceId: int, pid: int, moduleName: str, functionName: str) -> int:
        ...
        Returns:
            成功返回函数地址, 失败返回0
        """
        return OLAPlugDLLHelper.DmaGetProcAddress(self.OLAObject, deviceId, pid, moduleName, functionName)
    ...
    def DmaReadInt(self, deviceId: int, pid: int, addr: str, _type: int) -> int:
        ...
        Returns:
            None
        """
        return OLAPlugDLLHelper.DmaReadInt(self.OLAObject, deviceId, pid, addr, _type)
    ...
    def DmaReadString(self, deviceId: int, pid: int, addr: str, _type: int, _len: int) -> str:
        ...
        Returns:
            None
        """
        return self.PtrToStringUTF8(OLAPlugDLLHelper.DmaReadString(self.OLAObject, deviceId, pid, addr, _type, _len))
    ...
    def DmaWriteInt(self, deviceId: int, pid: int, addr: str, _type: int, value: int) -> int:
        ...
        Returns:
            None
        """
        return OLAPlugDLLHelper.DmaWriteInt(self.OLAObject, deviceId, pid, addr, _type, value)
    ...
    def DmaWriteString(self, deviceId: int, pid: int, addr: str, _type: int, value: str) -> int:
        ...
        Returns:
            None
        """
        return OLAPlugDLLHelper.DmaWriteString(self.OLAObject, deviceId, pid, addr, _type, value)
    ...
    def DrawGuiGetPosition(self, handle: int, x: int | None = None, y: int | None = None) -> tuple[int, int, int]:
        """获取对象位置.
    ...
    def DrawGuiGetSize(self, handle: int, width: int | None = None, height: int | None = None) -> tuple[int, int, int]:
        """获取对象尺寸.
    ...
    def KeOpenProcess(self, pid: int, process_handle: int | None = None) -> tuple[int, int]:
        """打开进程.
    ...
    def KeOpenThread(self, thread_id: int, thread_handle: int | None = None) -> tuple[int, int]:
        """打开线程.
    ...
    def ProtectFileQueryProtectedPath(self, path: str, mode: int | None = None) -> tuple[int, int]:
        """查询路径是否受保护.
    ...
    def VipProtectAddProtect(self, pid: int, path: str, mode: int, permission: int) -> int:
        ...
        Args:
            ...
            permission: 保护权限：位标志组合，VIP_PERMISSION_BLOCK_OPEN |VIP_PERMISSION_HIDE_INFORMATION |
                VIP_PERMISSION_BLOCK_MEMORY | VIP_PERMISSION_BLOCK_WINDOWS
    ...
    def ConvertRSAPublicKey(self, publicKey: str, inputType: int, outputType: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.ConvertRSAPublicKey(self.OLAObject, publicKey, inputType, outputType)
        )
    ...
    def ConvertRSAPrivateKey(self, privateKey: str, inputType: int, outputType: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.ConvertRSAPrivateKey(self.OLAObject, privateKey, inputType, outputType)
        )
    ...
    def SignWithRsa(self, message: str, privateCer: str, shaType: int, paddingType: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.SignWithRsa(self.OLAObject, message, privateCer, shaType, paddingType)
        )
    ...
    def PBKDF2(self, password: str, salt: str, iterations: int, keyLength: int, shaType: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.PBKDF2(self.OLAObject, password, salt, iterations, keyLength, shaType)
        )
    ...
    def RegisterHotkey(self, keycode: int, modifiers: int, callback: Callable[[int, int], int]) -> int:
        ...
        Args:
            keycode: 按键码
            modifiers: 修饰键组合，使用Modifier枚举值的位或组合，比如按下Ctrl+Alt modifiers:2+8=10enum 0 无掩码enum 1 左Shift键掩码enum 2
                左Ctrl键掩码enum 4 左Meta键掩码enum 8 左Alt键掩码enum 16 右Shift键掩码enum 32 右Ctrl键掩码enum 64 右Meta键掩码enum 128 右Alt键掩码
    ...
    def UnregisterHotkey(self, keycode: int, modifiers: int) -> int:
        ...
        Args:
            keycode: 按键码
            modifiers: 修饰键组合，使用Modifier枚举值的位或组合，比如按下Ctrl+Alt modifiers:2+8=10enum 1 左Shift键掩码enum 2 左Ctrl键掩码enum 4
                左Meta键掩码enum 8 左Alt键掩码enum 16 右Shift键掩码enum 32 右Ctrl键掩码enum 64 右Meta键掩码enum 128 右Alt键掩码
    ...
    def JsonParse(self, _str: str, err: int | None = None) -> tuple[int, int]:
        """解析JSON字符串.
    ...
    def JsonStringify(self, obj: int, indent: int, err: int | None = None) -> tuple[str, int]:
        """将JSON对象序列化为字符串.
    ...
    def JsonGetValue(self, obj: int, key: str, err: int | None = None) -> tuple[int, int]:
        """获取JSON对象中的值.
    ...
    def JsonGetArrayItem(self, arr: int, index: int, err: int | None = None) -> tuple[int, int]:
        """获取JSON数组中的元素.
    ...
    def JsonGetString(self, obj: int, key: str, err: int | None = None) -> tuple[str, int]:
        """获取JSON对象中的字符串值.
    ...
    def JsonGetNumber(self, obj: int, key: str, err: int | None = None) -> tuple[float, int]:
        """获取JSON对象中的数值.
    ...
    def JsonGetBool(self, obj: int, key: str, err: int | None = None) -> tuple[int, int]:
        """获取JSON对象中的布尔值.
    ...
    def JsonGetSize(self, obj: int, err: int | None = None) -> tuple[int, int]:
        """获取JSON对象或数组的大小.
    ...
    def ParseMatchImageAllJson(
        ...
        Returns:
            ...
            0: 解析失败
        """
        return OLAPlugDLLHelper.ParseMatchImageAllJson(
            _str, parseIndex, matchState, x, y, width, height, matchVal, angle, index
        )
    ...
    def GenerateMouseTrajectory(self, startX: int, startY: int, endX: int, endY: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.GenerateMouseTrajectory(self.OLAObject, startX, startY, endX, endY)
        )
    ...
    def GetCursorPos(self, x: int | None = None, y: int | None = None) -> tuple[int, int, int]:
        """获取鼠标位置.
    ...
    def FindDataEx(self, hwnd: int, addr_range: str, data: str, step: int, multi_thread: int, mode: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindDataEx(self.OLAObject, hwnd, addr_range, data, step, multi_thread, mode)
        )
    ...
    def FindDouble(self, hwnd: int, addr_range: str, double_value_min: float, double_value_max: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindDouble(self.OLAObject, hwnd, addr_range, double_value_min, double_value_max)
        )
    ...
    def FindDoubleEx(
        ...
        hwnd: int,
        addr_range: str,
        double_value_min: float,
        double_value_max: float,
        step: int,
        multi_thread: int,
        mode: int,
    ) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindDoubleEx(
                self.OLAObject, hwnd, addr_range, double_value_min, double_value_max, step, multi_thread, mode
            )
        )
    ...
    def FindFloat(self, hwnd: int, addr_range: str, float_value_min: float, float_value_max: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindFloat(self.OLAObject, hwnd, addr_range, float_value_min, float_value_max)
        )
    ...
    def FindFloatEx(
        ...
        hwnd: int,
        addr_range: str,
        float_value_min: float,
        float_value_max: float,
        step: int,
        multi_thread: int,
        mode: int,
    ) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindFloatEx(
                self.OLAObject, hwnd, addr_range, float_value_min, float_value_max, step, multi_thread, mode
            )
        )
    ...
    def FindInt(self, hwnd: int, addr_range: str, int_value_min: int, int_value_max: int, _type: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindInt(self.OLAObject, hwnd, addr_range, int_value_min, int_value_max, _type)
        )
    ...
    def FindIntEx(
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindIntEx(
                self.OLAObject, hwnd, addr_range, int_value_min, int_value_max, _type, step, multi_thread, mode
            )
        )
    ...
    def FindStringEx(
        self, hwnd: int, addr_range: str, string_value: str, _type: int, step: int, multi_thread: int, mode: int
    ) -> str:
        """搜索指定范围内的字符串.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindStringEx(
                self.OLAObject, hwnd, addr_range, string_value, _type, step, multi_thread, mode
            )
        )
    ...
    def ReadData(self, hwnd: int, addr: str, _len: int) -> str:
        ...
        Args:
            hwnd: 窗口句柄
            addr:
                地址，支持CE数据格式比如：[[[<module>+offset1]+offset2]+offset3]，<Game.exe>+1234+8+4，[<Game.exe>+1234]+8+4，[[<Game.exe>+1234]+8
                ]+4，<Game.exe>+1234，[0x12345678]+10
            _len: 长度
    ...
    def GetRemoteApiAddress(self, hwnd: int, module_name: str, fun_name: str) -> int:
        ...
        Returns:
            成功返回远程API地址,失败返回0
        """
        return OLAPlugDLLHelper.GetRemoteApiAddress(self.OLAObject, hwnd, module_name, fun_name)
    ...
    def VirtualProtectEx(
        self, hwnd: int, addr: int, size: int, newProtect: int, oldProtect: int | None = None
    ) -> tuple[int, int]:
        """修改指定的内存保护属性.
    ...
    def CreateRemoteThread(
        self, hwnd: int, lpStartAddress: int, lpParameter: int, dwCreationFlags: int, lpThreadId: int | None = None
    ) -> tuple[int, int]:
        """在指定的窗口所在进程创建一个线程.
        ...
        """
        return OLAPlugDLLHelper.CreateRemoteThread(
            self.OLAObject, hwnd, lpStartAddress, lpParameter, dwCreationFlags, lpThreadId
        )
    ...
    def HookRemoteApi(self, hwnd: int, targetAddr: int, size: int, hook_proc: int) -> int:
        ...
        """
        return OLAPlugDLLHelper.HookRemoteApi(self.OLAObject, hwnd, targetAddr, size, hook_proc)
    ...
    def UnhookRemoteApi(self, hwnd: int, targetAddr: int) -> int:
        ...
        Returns:
            ...
            1: 成功
        """
        return OLAPlugDLLHelper.UnhookRemoteApi(self.OLAObject, hwnd, targetAddr)
    ...
    def SetOcrConfig(self, configStr: str | dict) -> int:
        """设置OCR配置.
    ...
    def OcrFromDict(
        self, x1: int, y1: int, x2: int, y2: int, colorJson: str | list[dict], dict_name: str, matchVal: float
    ) -> str:
        """从字库中识别文字.
        ...
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.OcrFromDict(self.OLAObject, x1, y1, x2, y2, colorJson, dict_name, matchVal)
        )

    def OcrFromDictDetails(
        self, x1: int, y1: int, x2: int, y2: int, colorJson: str | list[dict], dict_name: str, matchVal: float
    ) -> dict:
        """从字库中识别文字.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.OcrFromDictDetails(self.OLAObject, x1, y1, x2, y2, colorJson, dict_name, matchVal)
        )
        if result == "":
            return {}
        return json.loads(result)

    def OcrFromDictPtr(self, ptr: int, colorJson: str | list[dict], dict_name: str, matchVal: float) -> str:
        """从字库中识别文字.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.OcrFromDictPtr(self.OLAObject, ptr, colorJson, dict_name, matchVal)
        )

    def OcrFromDictPtrDetails(self, ptr: int, colorJson: str | list[dict], dict_name: str, matchVal: float) -> dict:
        """从字库中识别文字.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.OcrFromDictPtrDetails(self.OLAObject, ptr, colorJson, dict_name, matchVal)
        )
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindStrDetail(
        self, x1: int, y1: int, x2: int, y2: int, _str: str, colorJson: str | list[dict], _dict: str, matchVal: float
    ) -> dict:
        """查找指定文字的坐标.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindStrDetail(self.OLAObject, x1, y1, x2, y2, _str, colorJson, _dict, matchVal)
        )
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindStrAll(
        ...
        Args:
            ...
            y2: 右下角y坐标
            _str: 查找字符串
            colorJson: 颜色列表的JSON字符串，格式如：[{"StartColor": "3278FA", "EndColor": "6496FF","Type": 0}, {"StartColor":
                "3278FA", "EndColor": "6496FF", "Type": 1}]
            _dict: 字库名称
            matchVal: 匹配值
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindStrAll(self.OLAObject, x1, y1, x2, y2, _str, colorJson, _dict, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindStrFromPtr(self, source: int, _str: str, colorJson: str | list[dict], _dict: str, matchVal: float) -> dict:
        """查找图片中的文字.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindStrFromPtr(self.OLAObject, source, _str, colorJson, _dict, matchVal)
        )
        if result == "":
            return {}
        return json.loads(result)

    def FindStrFromPtrAll(
        self, source: int, _str: str, colorJson: str | list[dict], _dict: str, matchVal: float
    ) -> list[dict]:
        """查找文字返回全部结果.
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindStrFromPtrAll(self.OLAObject, source, _str, colorJson, _dict, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)

    def FastNumberOcrFromPtr(self, source: int, numbers: str, colorJson: str | list[dict], matchVal: float) -> int:
        """快速识别数字.
    ...
    def FastNumberOcr(
        self, x1: int, y1: int, x2: int, y2: int, numbers: str, colorJson: str | list[dict], matchVal: float
    ) -> int:
        """快速识别数字.
    ...
    def GetScreenDataBmp(
        self, x1: int, y1: int, x2: int, y2: int, data: int | None = None, dataLen: int | None = None
    ) -> tuple[int, int, int]:
        """获取绑定窗口指定区域的BMP原始数据.
    ...
    def GetImageData(
        self, imgPtr: int, data: int | None = None, size: int | None = None, stride: int | None = None
    ) -> tuple[int, int, int, int]:
        """从图像句柄读取像素数据.
    ...
    def MatchImageFromPath(
        self, source: str, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> dict:
        """使用文件路径在源图中匹配模板图.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImageFromPath(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)

    def MatchImageFromPathAll(
        self, source: str, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImageFromPathAll(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return []
        return json.loads(result)

    def MatchImagePtrFromPath(
        self, source: int, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> dict:
        """使用内存源图与文件模板进行匹配.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImagePtrFromPath(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)

    def MatchImagePtrFromPathAll(
        self, source: int, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> list[dict]:
        """使用内存源图与文件模板查找所有匹配.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImagePtrFromPathAll(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return []
        return json.loads(result)
    ...
    def MatchWindowsFromPtr(
        self, x1: int, y1: int, x2: int, y2: int, templ: int, matchVal: float, _type: int, angle: float, scale: float
    ) -> dict:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsFromPtr(self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)

    def MatchImageFromPtr(
        self, source: int, templ: int, matchVal: float, _type: int, angle: float, scale: float
    ) -> dict:
        """在指定图片中查找指定图像（使用内存数据）.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImageFromPtr(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)

    def MatchImageFromPtrAll(
        self, source: int, templ: int, matchVal: float, _type: int, angle: float, scale: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchImageFromPtrAll(self.OLAObject, source, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return []
        return json.loads(result)

    def MatchWindowsFromPtrAll(
        self, x1: int, y1: int, x2: int, y2: int, templ: int, matchVal: float, _type: int, angle: float, scale: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsFromPtrAll(
                self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale
            )
        )
        if result == "":
            return []
    ...
    def MatchWindowsFromPath(
        self, x1: int, y1: int, x2: int, y2: int, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> dict:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsFromPath(self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)

    def MatchWindowsFromPathAll(
        self, x1: int, y1: int, x2: int, y2: int, templ: str, matchVal: float, _type: int, angle: float, scale: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsFromPathAll(
                self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale
            )
        )
        if result == "":
    ...
    def MatchWindowsThresholdFromPtr(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsThresholdFromPtr(
                self.OLAObject, x1, y1, x2, y2, colorJson, templ, matchVal, angle, scale
            )
        )
        if result == "":
            return {}
    ...
    def MatchWindowsThresholdFromPtrAll(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsThresholdFromPtrAll(
                self.OLAObject, x1, y1, x2, y2, colorJson, templ, matchVal, angle, scale
            )
        )
        if result == "":
    ...
    def MatchWindowsThresholdFromPath(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsThresholdFromPath(
                self.OLAObject, x1, y1, x2, y2, colorJson, templ, matchVal, angle, scale
            )
        )
        if result == "":
    ...
    def MatchWindowsThresholdFromPathAll(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        if not isinstance(colorJson, str):
            colorJson = json.dumps(colorJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchWindowsThresholdFromPathAll(
                self.OLAObject, x1, y1, x2, y2, colorJson, templ, matchVal, angle, scale
            )
        )
        if result == "":
    ...
    def FindColorEx(
        self, x1: int, y1: int, x2: int, y2: int, colorJson: str, _dir: int, x: int | None = None, y: int | None = None
    ) -> tuple[int, int, int]:
        """在绑定窗口中查找指定颜色.
    ...
    def FindMultiColor(
        ...
        return OLAPlugDLLHelper.FindMultiColor(self.OLAObject, x1, y1, x2, y2, colorJson, pointJson, sim, _dir, x, y)

    def FindMultiColorList(
        self, x1: int, y1: int, x2: int, y2: int, colorJson: str | list[dict], pointJson: str | list[dict], sim: float
    ) -> list[dict]:
        """在绑定窗口中查找多色点列表.
        ...
        if not isinstance(pointJson, str):
            pointJson = json.dumps(pointJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindMultiColorList(self.OLAObject, x1, y1, x2, y2, colorJson, pointJson, sim)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindMultiColorFromPtr(
        self,
        ptr: int,
        colorJson: str | list[dict],
        pointJson: str | list[dict],
        ...
        if not isinstance(pointJson, str):
            pointJson = json.dumps(pointJson)
        return OLAPlugDLLHelper.FindMultiColorFromPtr(self.OLAObject, ptr, colorJson, pointJson, sim, _dir, x, y)

    def FindMultiColorListFromPtr(
        self, ptr: int, colorJson: str | list[dict], pointJson: str | list[dict], sim: float
    ) -> list[dict]:
        """在内存图像中查找多色点列表.
        ...
        if not isinstance(pointJson, str):
            pointJson = json.dumps(pointJson)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindMultiColorListFromPtr(self.OLAObject, ptr, colorJson, pointJson, sim)
        )
        if result == "":
            return []
        return json.loads(result)

    def GetImageSize(self, ptr: int, width: int | None = None, height: int | None = None) -> tuple[int, int, int]:
        """获取图像的宽度和高度.
    ...
    def FindColorBlockList(
        ...
        if not isinstance(colorList, str):
            colorList = json.dumps(colorList)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindColorBlockList(self.OLAObject, x1, y1, x2, y2, colorList, count, width, height, _type)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindColorBlockListPtr(
        self, ptr: int, colorList: str | list[dict], count: int, width: int, height: int, _type: int
    ) -> list[dict]:
        ...
        if not isinstance(colorList, str):
            colorList = json.dumps(colorList)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindColorBlockListPtr(self.OLAObject, ptr, colorList, count, width, height, _type)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindColorBlockEx(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        if not isinstance(colorList, str):
            colorList = json.dumps(colorList)
        return OLAPlugDLLHelper.FindColorBlockEx(
            self.OLAObject, x1, y1, x2, y2, colorList, count, width, height, _dir, x, y
        )

    def FindColorBlockPtrEx(
        self,
        ptr: int,
        colorList: str | list[dict],
        count: int,
    ...
    def FindColorBlockListEx(
        ...
        if not isinstance(colorList, str):
            colorList = json.dumps(colorList)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindColorBlockListEx(
                self.OLAObject, x1, y1, x2, y2, colorList, count, width, height, _type, _dir
            )
        )
        if result == "":
            return []
    ...
    def FindColorBlockListPtrEx(
        self, ptr: int, colorList: str | list[dict], count: int, width: int, height: int, _type: int, _dir: int
    ) -> list[dict]:
        """在内存图像中查找指定颜色的所有连续区域（色块列表）.
        ...
        if not isinstance(colorList, str):
            colorList = json.dumps(colorList)
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindColorBlockListPtrEx(self.OLAObject, ptr, colorList, count, width, height, _type, _dir)
        )
        if result == "":
            return []
        return json.loads(result)

    def GetColorNum(self, x1: int, y1: int, x2: int, y2: int, colorList: str | list[dict]) -> int:
    ...
    def GetColorNumPtr(self, ptr: int, colorList: str | list[dict]) -> int:
        """统计内存图像中指定颜色的像素数量.
    ...
    def GetThresholdImageFromMultiColorPtr(self, ptr: int, colorJson: str | list[dict]) -> int:
        """根据多色点生成阈值图像.
    ...
    def GetThresholdImageFromMultiColor(self, x1: int, y1: int, x2: int, y2: int, colorJson: str | list[dict]) -> int:
        """根据多色点生成阈值图像（从屏幕区域）.
    ...
    def SetColorsToNewColor(self, ptr: int, colorJson: str | list[dict], color: str) -> int:
    ...
    def RemoveOtherColors(self, ptr: int, colorJson: str | list[dict]) -> int:
        """保留图像中指定颜色，其余颜色变为黑色.
    ...
    def DrawFillPoly(self, ptr: int, pointJson: str | list[dict], color: str) -> int:
        """在图像上绘制填充多边形.
    ...
    def CreateQRCodeEx(
        self, _str: str, pixelsPerModule: int, version: int, correction_level: int, mode: int, structure_number: int
    ) -> int:
        """高级生成二维码图像.
        ...
        Returns:
            返回二维码图像数据指针，需调用FreeImageData释放内存；失败返回0
        """
        return OLAPlugDLLHelper.CreateQRCodeEx(
            self.OLAObject, _str, pixelsPerModule, version, correction_level, mode, structure_number
        )

    def MatchAnimationFromPtr(
        self,
        x1: int,
        y1: int,
        x2: int,
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchAnimationFromPtr(
                self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale, delay, time, threadCount
            )
        )
        if result == "":
            return {}
    ...
    def MatchAnimationFromPath(
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.MatchAnimationFromPath(
                self.OLAObject, x1, y1, x2, y2, templ, matchVal, _type, angle, scale, delay, time, threadCount
            )
        )
        if result == "":
    ...
    def GetImageBmpData(self, imgPtr: int, data: int | None = None, size: int | None = None) -> tuple[int, int, int]:
        """获取图像的BMP格式数据.
    ...
    def GetImagePngData(self, imgPtr: int, data: int | None = None, size: int | None = None) -> tuple[int, int, int]:
        """获取图像的PNG格式数据.
    ...
    def SetPixelList(self, image: int, points: str | list[dict], color: str) -> int:
        """批量设置图像中多个像素点的颜色.
    ...
    def Hex2ARGB(
        self, hex: str, a: int | None = None, r: int | None = None, g: int | None = None, b: int | None = None
    ) -> tuple[int, int, int, int, int]:
        """十六进制颜色解析为ARGB.
    ...
    def Hex2RGB(
        self, hex: str, r: int | None = None, g: int | None = None, b: int | None = None
    ) -> tuple[int, int, int, int]:
        """十六进制颜色解析为RGB.
    ...
    def GetConnectedComponents(self, ptr: int, points: str | list[dict], tolerance: int) -> int:
        """基于种子点获取连通域.
    ...
    def FastMatch(self, ptr: int, templatePtr: int, matchVal: float, _type: int, angle: float, scale: float) -> dict:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FastMatch(self.OLAObject, ptr, templatePtr, matchVal, _type, angle, scale)
        )
        if result == "":
            return {}
        return json.loads(result)
    ...
    def GetROIRegion(
        self, ptr: int, x1: int | None = None, y1: int | None = None, x2: int | None = None, y2: int | None = None
    ) -> tuple[int, int, int, int, int]:
        """获取ROI区域.
    ...
    def ImageStitchFromPath(self, path: str, trajectory: int | None = None) -> tuple[int, int]:
        """从路径拼接图片.
    ...
    def ImageStitchGetResult(self, imageStitch: int, trajectory: int | None = None) -> tuple[int, int]:
        """获取拼接图片结果.
    ...
    def FindImageFromPtr(self, source: int, templ: int, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindImageFromPtr(self.OLAObject, source, templ, deltaColor, matchVal, _dir)
        )
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindImageFromPtrAll(self, source: int, templ: int, deltaColor: str, matchVal: float) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindImageFromPtrAll(self.OLAObject, source, templ, deltaColor, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindImageFromPath(self, source: str, templ: str, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindImageFromPath(self.OLAObject, source, templ, deltaColor, matchVal, _dir)
        )
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindImageFromPathAll(self, source: str, templ: str, deltaColor: str, matchVal: float) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindImageFromPathAll(self.OLAObject, source, templ, deltaColor, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindWindowsFromPtr(
        self, x1: int, y1: int, x2: int, y2: int, templ: int, deltaColor: str, matchVal: float, _dir: int
    ) -> dict:
        """在绑定窗口中查找指定图像（使用内存数据）.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindWindowsFromPtr(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal, _dir)
        )
        if result == "":
            return {}
        return json.loads(result)

    def FindWindowsFromPtrAll(
        self, x1: int, y1: int, x2: int, y2: int, templ: int, deltaColor: str, matchVal: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindWindowsFromPtrAll(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)

    def FindWindowsFromPath(
        self, x1: int, y1: int, x2: int, y2: int, templ: str, deltaColor: str, matchVal: float, _dir: int
    ) -> dict:
        """在绑定窗口中查找指定图像（使用文件路径）.
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindWindowsFromPath(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal, _dir)
        )
        if result == "":
            return {}
        return json.loads(result)

    def FindWindowsFromPathAll(
        self, x1: int, y1: int, x2: int, y2: int, templ: str, deltaColor: str, matchVal: float
    ) -> list[dict]:
        ...
        """
        result = self.PtrToStringUTF8(
            OLAPlugDLLHelper.FindWindowsFromPathAll(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal)
        )
        if result == "":
            return []
        return json.loads(result)
    ...
    def RegistryCompareKeys(self, rootKey1: int, subKey1: str, rootKey2: int, subKey2: str) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.RegistryCompareKeys(self.OLAObject, rootKey1, subKey1, rootKey2, subKey2)
        )
    ...
    def RegistrySearchKeys(self, rootKey: int, searchPath: str, searchPattern: str, recursive: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.RegistrySearchKeys(self.OLAObject, rootKey, searchPath, searchPattern, recursive)
        )
    ...
    def ExtractFramesToFiles(
        ...
        Returns:
            返回提取的帧数，失败返回0
        """
        return OLAPlugDLLHelper.ExtractFramesToFiles(
            self.OLAObject, videoHandle, startFrame, endFrame, step, outputDir, imageFormat, jpegQuality
        )

    def ExtractFramesByInterval(
        self, videoHandle: int, intervalSeconds: float, outputDir: str, imageFormat: str
    ) -> int:
        """按时间间隔提取帧并保存为文件.
        ...
        Returns:
            返回提取的帧数，失败返回0
        """
        return OLAPlugDLLHelper.ExtractFramesByInterval(
            self.OLAObject, videoHandle, intervalSeconds, outputDir, imageFormat
        )

    def ExtractKeyFrames(
        self, videoHandle: int, threshold: float, maxFrames: int, outputDir: str, imageFormat: str
    ) -> int:
        """提取关键帧（基于场景变化检测）.
        ...
        Returns:
            返回提取的关键帧数，失败返回0
        """
        return OLAPlugDLLHelper.ExtractKeyFrames(
            self.OLAObject, videoHandle, threshold, maxFrames, outputDir, imageFormat
        )
    ...
    def GetWindowRect(
        self, hwnd: int, x1: int | None = None, y1: int | None = None, x2: int | None = None, y2: int | None = None
    ) -> tuple[int, int, int, int, int]:
        """获取指定窗口的矩形区域（相对于屏幕）.
    ...
    def GetClientSize(self, hwnd: int, width: int | None = None, height: int | None = None) -> tuple[int, int, int]:
        """获取指定窗口客户区的大小.
    ...
    def EnumWindowByProcess(self, process_name: str, title: str, class_name: str, _filter: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.EnumWindowByProcess(self.OLAObject, process_name, title, class_name, _filter)
        )
    ...
    def EnumWindowByProcessId(self, pid: int, title: str, class_name: str, _filter: int) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.EnumWindowByProcessId(self.OLAObject, pid, title, class_name, _filter)
        )

    def EnumWindowSuper(self, spec1: str, flag1: int, type1: int, spec2: str, flag2: int, type2: int, sort: int) -> str:
        r"""高级窗口查找，支持多种条件和模糊匹配.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.EnumWindowSuper(self.OLAObject, spec1, flag1, type1, spec2, flag2, type2, sort)
        )
    ...
    def FindWindowSuper(self, spec1: str, flag1: int, type1: int, spec2: str, flag2: int, type2: int) -> int:
        r"""高级窗口查找，功能与 EnumWindowSuper 类似.
    ...
    def CreateChildProcess(
        self, applicationName: str, commandLine: str, currentDirectory: str, showType: int, parentProcessId: int
    ) -> int:
        r"""创建子进程.
        ...
        """
        return OLAPlugDLLHelper.CreateChildProcess(
            self.OLAObject, applicationName, commandLine, currentDirectory, showType, parentProcessId
        )
    ...
    def YoloLoadModel(
        ...
        Args:
            ...
            inferenceType: 推理类型0.Detect物体检测 1.Classify图像分类 2.Segment实例分割 3.Pose姿态估计 4.Obb旋转框检测5.KeyPoint关键点检测 6.Text文字识别
                7.OCR文字识别 8.车牌识别 9.人脸识别 10.手势识别11.动作识别 12.行为识别 13.运动识别 14.轨迹识别 15.轨迹预测 16.轨迹跟踪note: 5-16未开放服务
            inferenceDevice: 推理设备0.GPU0 1.GPU1 2.GPU2 3.GPU3 以此类推，默认使用GPU0若无GPU设备，则无法使用，CPU版本后续推出

        Returns:
            模型句柄（失败返回0）
        """
        return OLAPlugDLLHelper.YoloLoadModel(
            self.OLAObject, modelPath, outputPath, names_label, password, modelType, inferenceType, inferenceDevice
        )
    ...
    def YoloLoadModelMemory(
        self, memoryAddr: int, size: int, modelType: int, inferenceType: int, inferenceDevice: int
    ) -> int:
        """从内存加载模型.
        ...
        Returns:
            模型句柄（失败返回0）
        """
        return OLAPlugDLLHelper.YoloLoadModelMemory(
            self.OLAObject, memoryAddr, size, modelType, inferenceType, inferenceDevice
        )
    ...
    def YoloDetect(
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloDetect(
                self.OLAObject, modelHandle, x1, y1, x2, y2, classes, confidence, iou, maxDetections
            )
        )
    ...
    def YoloDetectFromPtr(
        self, modelHandle: int, imagePtr: int, classes: str, confidence: float, iou: float, maxDetections: int
    ) -> str:
        """从图像指针检测物体.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloDetectFromPtr(
                self.OLAObject, modelHandle, imagePtr, classes, confidence, iou, maxDetections
            )
        )

    def YoloDetectFromFile(
        self, modelHandle: int, imagePath: str, classes: str, confidence: float, iou: float, maxDetections: int
    ) -> str:
        """从文件路径检测物体.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloDetectFromFile(
                self.OLAObject, modelHandle, imagePath, classes, confidence, iou, maxDetections
            )
        )

    def YoloDetectFromBase64(
        self, modelHandle: int, base64Data: str, classes: str, confidence: float, iou: float, maxDetections: int
    ) -> str:
        """从Base64编码检测物体.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloDetectFromBase64(
                self.OLAObject, modelHandle, base64Data, classes, confidence, iou, maxDetections
            )
        )

    def YoloDetectBatch(
        self, modelHandle: int, imagesJson: str, classes: str, confidence: float, iou: float, maxDetections: int
    ) -> str:
        """批量检测物体.
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloDetectBatch(
                self.OLAObject, modelHandle, imagesJson, classes, confidence, iou, maxDetections
            )
        )
    ...
    def YoloSegment(self, modelHandle: int, x1: int, y1: int, x2: int, y2: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloSegment(self.OLAObject, modelHandle, x1, y1, x2, y2, confidence, iou)
        )
    ...
    def YoloSegmentFromPtr(self, modelHandle: int, imagePtr: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloSegmentFromPtr(self.OLAObject, modelHandle, imagePtr, confidence, iou)
        )
    ...
    def YoloPose(self, modelHandle: int, x1: int, y1: int, x2: int, y2: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloPose(self.OLAObject, modelHandle, x1, y1, x2, y2, confidence, iou)
        )
    ...
    def YoloPoseFromPtr(self, modelHandle: int, imagePtr: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloPoseFromPtr(self.OLAObject, modelHandle, imagePtr, confidence, iou)
        )
    ...
    def YoloObb(self, modelHandle: int, x1: int, y1: int, x2: int, y2: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloObb(self.OLAObject, modelHandle, x1, y1, x2, y2, confidence, iou)
        )
    ...
    def YoloObbFromPtr(self, modelHandle: int, imagePtr: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloObbFromPtr(self.OLAObject, modelHandle, imagePtr, confidence, iou)
        )
    ...
    def YoloKeyPoint(self, modelHandle: int, x1: int, y1: int, x2: int, y2: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloKeyPoint(self.OLAObject, modelHandle, x1, y1, x2, y2, confidence, iou)
        )
    ...
    def YoloKeyPointFromPtr(self, modelHandle: int, imagePtr: int, confidence: float, iou: float) -> str:
        ...
        """
        return self.PtrToStringUTF8(
            OLAPlugDLLHelper.YoloKeyPointFromPtr(self.OLAObject, modelHandle, imagePtr, confidence, iou)
        )
