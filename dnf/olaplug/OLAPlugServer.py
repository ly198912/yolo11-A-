...
class OLAPlugServer:
    ...
    def FindMultiColorList(self, x1: int, y1: int, x2: int, y2: int, colorJson: Union[str, List[dict]], pointJson: Union[str, List[dict]], sim: float) -> List[dict]:
        ...
        if not isinstance(pointJson, str):
            pointJson = json.dumps(pointJson)
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindMultiColorList(self.OLAObject, x1, y1, x2, y2, colorJson, pointJson, sim))
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindMultiColorListFromPtr(self, ptr: int, colorJson: Union[str, List[dict]], pointJson: Union[str, List[dict]], sim: float) -> List[dict]:
        ...
        if not isinstance(pointJson, str):
            pointJson = json.dumps(pointJson)
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindMultiColorListFromPtr(self.OLAObject, ptr, colorJson, pointJson, sim))
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindImageFromPtr(self, source: int, templ: int, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindImageFromPtr(self.OLAObject, source, templ, deltaColor, matchVal, _dir))
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindImageFromPtrAll(self, source: int, templ: int, deltaColor: str, matchVal: float) -> List[dict]:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindImageFromPtrAll(self.OLAObject, source, templ, deltaColor, matchVal))
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindImageFromPath(self, source: str, templ: str, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindImageFromPath(self.OLAObject, source, templ, deltaColor, matchVal, _dir))
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindImageFromPathAll(self, source: str, templ: str, deltaColor: str, matchVal: float) -> List[dict]:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindImageFromPathAll(self.OLAObject, source, templ, deltaColor, matchVal))
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindWindowsFromPtr(self, x1: int, y1: int, x2: int, y2: int, templ: int, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindWindowsFromPtr(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal, _dir))
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindWindowsFromPtrAll(self, x1: int, y1: int, x2: int, y2: int, templ: int, deltaColor: str, matchVal: float) -> List[dict]:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindWindowsFromPtrAll(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal))
        if result == "":
            return []
        return json.loads(result)
    ...
    def FindWindowsFromPath(self, x1: int, y1: int, x2: int, y2: int, templ: str, deltaColor: str, matchVal: float, _dir: int) -> dict:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindWindowsFromPath(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal, _dir))
        if result == "":
            return {}
        return json.loads(result)
    ...
    def FindWindowsFromPathAll(self, x1: int, y1: int, x2: int, y2: int, templ: str, deltaColor: str, matchVal: float) -> List[dict]:
        ...
        Notes:
        """
        result = self.PtrToStringUTF8(OLAPlugDLLHelper.FindWindowsFromPathAll(self.OLAObject, x1, y1, x2, y2, templ, deltaColor, matchVal))
        if result == "":
            return []
        return json.loads(result)
