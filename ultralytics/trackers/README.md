...
# model = YOLO("path/to/shzn.pt")  # Load a custom trained model
...
# yolo track model=path/to/shzn.pt source="https://youtu.be/LNwODJXcvt4" # Custom trained model

# Track using ByteTrack tracker
# yolo track model=path/to/shzn.pt tracker="bytetrack.yaml"
```
